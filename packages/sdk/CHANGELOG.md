...
## [1.5.0](https://github.com/Evoke-Platform/evoke-sdk/compare/sdk@1.4.0...sdk@1.5.0) (2026-05-29)

### Features

-   add `fileContent` property type ([b36ef01](https://github.com/Evoke-Platform/evoke-sdk/commit/b36ef0185af0f2b5df115205ceff3ca2830ee856))
-   add `fileContent` property type ([f74a856](https://github.com/Evoke-Platform/evoke-sdk/commit/f74a8564901e648d127e9bcfb3a6ac60039a71dd))
...
-   add actions and forms for related object and collection entry display ([2dc30b5](https://github.com/Evoke-Platform/evoke-sdk/commit/2dc30b513b42c1bb59606d48e6179b510d50b69f))
-   add criteria validation for dynamic related object properties ([2bd2d3b](https://github.com/Evoke-Platform/evoke-sdk/commit/2bd2d3b5e5723160bd8b28ef530e27e75043ad9a))
-   add defaultViewId to Obj type ([4b9e772](https://github.com/Evoke-Platform/evoke-sdk/commit/4b9e772119549f2e614bce337c071c562d5cd7fa))
-   add many to many collections to allowed data types ([90a803a](https://github.com/Evoke-Platform/evoke-sdk/commit/90a803ae7c4214f03f7197c58a017d68505d0452))
-   add protected property configuration to property type ([7a9a94f](https://github.com/Evoke-Platform/evoke-sdk/commit/7a9a94f162672948629fe1e3de6c17a328f419d8))
-   add relatedObjectId property to DisplayConfiguration type ([8804503](https://github.com/Evoke-Platform/evoke-sdk/commit/8804503f7867669fc550edaedbcb4337bfe2e2e7))
...
-   **api:** add File type to Data type ([f983a81](https://github.com/Evoke-Platform/evoke-sdk/commit/f983a81f9684b2510162dee85575345f1732c395))
-   **api:** remove Callback<T> casting ([5bd9eb5](https://github.com/Evoke-Platform/evoke-sdk/commit/5bd9eb5c2bee5e27e0fdc10ba25f453b8cf059af))
...
-   **CDR-2507:** add File type ([01ccdf1](https://github.com/Evoke-Platform/evoke-sdk/commit/01ccdf1c81b9302cd01f4da4182190a34253f7e4))
...
-   **context:** allow BaseObjReference discriminator to be optional ([d0abbdb](https://github.com/Evoke-Platform/evoke-sdk/commit/d0abbdb06533c3baa50831da405cacd19de74575))
...
-   expose offlineEnabled in App context ([3d8a2b6](https://github.com/Evoke-Platform/evoke-sdk/commit/3d8a2b64dbd0a43d1aa528ba564dccdb5d406fa3))
...
-   remove `username` from `account` in authentication context ([28461dc](https://github.com/Evoke-Platform/evoke-sdk/commit/28461dc2ad13ea2521d96d16c5f13ab5cc5614f5))
...
-   **schema:** add betaRelease boolean property to widget schema ([3b62d27](https://github.com/Evoke-Platform/evoke-sdk/commit/3b62d27a9109e676469dcc1f94bb6c252313a962))
...
-   add `Content` as a valid `ViewEntry` ([eb8931b](https://github.com/Evoke-Platform/evoke-sdk/commit/eb8931bb6e244e597faf319713074b4258d0599f))
...
-   allow string validation to not include operator ([8414369](https://github.com/Evoke-Platform/evoke-sdk/commit/8414369478013881a7968db99adb19341864837b))
...
-   **CDR-2403:** require oidc instance as a prop to AuthenticationContext ([4c90c87](https://github.com/Evoke-Platform/evoke-sdk/commit/4c90c87ffae240a298296ba2bf69bf5a4233fa66))
...
-   don't capture user in authentication context ([5313409](https://github.com/Evoke-Platform/evoke-sdk/commit/53134096eb697d498ec3808e4bea27ef0252a192))
...
-   update naming of types ([95aec5e](https://github.com/Evoke-Platform/evoke-sdk/commit/95aec5eba7fc165beb205f56af442954459bfca9))
